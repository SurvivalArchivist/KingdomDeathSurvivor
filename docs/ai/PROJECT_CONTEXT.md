...
- Linux CI configures the `flathub` remote and installs `org.freedesktop.Platform//24.08` + `org.freedesktop.Sdk//24.08` with `sudo flatpak` before Flatpak packaging.
